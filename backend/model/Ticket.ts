...
import { Ticket as T_Ticket } from "@shared/shared_types.ts";
...
export default class Ticket extends Model<DTOTicket, DTOTicketCreate> implements DTOTicket {
    ...
    static async getTicketById(ticket_id: string): Promise<T_Ticket | null> {
        ...
        return S_DTOTicketExtendedParsed.parse(ticket) as unknown as T_Ticket;
    }
